...
function getJapaneseAttractionName(name) {
  switch (name) {
    ...
    case 'The Enchanted Tiki Room: Stitch Presents “Aloha E Komo Mai!”': return "魅惑のチキルーム：スティッチ・プレゼンツ「アロハ・エ・コモ・マイ！」";
    ...
    case "Westernland Shootin' Gallery": return "ウエスタンランド・シューティングギャラリー";
    ...
    case "“it's a small world”": return "イッツ・ア・スモールワールド";
    ...
    case "Pooh's Hunny Hunt": return "プーさんのハニーハント";
    ...
    case "Penny Arcade": return "ペニーアーケード";
    case "Enchanted Tale of Beauty and the Beast": return "美女と野獣“魔法のものがたり”";
    ...
    case "DisneySea Electric Railway (Port Discovery)": return "ディズニーシー・エレクトリックレールウェイ（ポートディスカバリー）";
    case "DisneySea Electric Railway (American Waterfront)": return "ディズニーシー・エレクトリックレールウェイ（アメリカンウォーターフロント）";
    ...
    case "The Leonardo Challenge": return "フォートレス・エクスプロレーション";
    case "Mermaid Lagoon Theater": return "マーメイドラグーンシアター";
